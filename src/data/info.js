...
export const education = [
  {
    id: 0,
    img: "",
    school: "UNLV Bootcamp",
    date: "January 2023 - November 2023",
    grade: "",
    desc: "The Software Development bootcamp curriculum covers topics like HTML, CSS, web accessibility, web design, JavaScript, SQL, React, front end and back end development. University of Nevada-Las Vegas Digital Skills Bootcamps is to prepare students for a variety of roles in the field. Career assistance is included in the curriculum with services like personal branding assistance, one-on-one coaching, and job lead assistance. Students complete several projects throughout the course to build a portfolio to show potential employers.",
    degree: "",
  },
];
...
export const projects = [

  {
    ...
    category: "",
    github: "https://github.com/ZorenVillareal/DealorNoDeal",
    webapp: "",
  },
  {
    id: 1,
